...
def downloadData2():
    # while True:
    toado_x = db.child("COT2").child("Angle").child("X").get()
    toado_y = db.child("COT2").child("Angle").child("Y").get()
    toado_z = db.child("COT2").child("Angle").child("Z").get()
    vanToc = db.child("COT2").child("SPEED").get()
    huongGio = db.child("COT2").child("DIRECTION").get()
...
def downloadDataElse2():
    Acc1 = db.child("COT2").child("Acc").child("X").get()
    Acc2 = db.child("COT2").child("Acc").child("Y").get()
    Acc3 = db.child("COT2").child("Acc").child("Z").get()

    Gyro1 = db.child("COT2").child("Gyro").child("X").get()
    Gyro2 = db.child("COT2").child("Gyro").child("Y").get()
    Gyro3 = db.child("COT2").child("Gyro").child("Z").get()
...
def calculatorWarn2():
    x, y, z, v, t = downloadData2()
    F1, F2, F3, F4, F5, F6, F7, F8, F9 = calculator2()
